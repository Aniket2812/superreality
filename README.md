...
For voice, add `OPENAI_API_KEY` to `.env`. It powers transcription, conversation, and speech output. To talk to the agent in your terminal, no LiveKit needed:
...
**Stack:** LiveKit voice + OpenAI, Cognee memory (Neo4j + pgvector), FastAPI, React 19, Cal.com + Telnyx, multi-tenant, MIT.
