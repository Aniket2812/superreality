...
class Config(BaseSettings):
    ...
    # NOTE: LIVEKIT_URL / LIVEKIT_API_KEY / LIVEKIT_API_SECRET and
    # OPENAI_API_KEY are read directly from the environment by the LiveKit
    # framework and OpenAI plugin.
