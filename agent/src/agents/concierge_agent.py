...
_RECORDING_NOTICE = (
    "Start by briefly and naturally letting the buyer know they are speaking with an AI "
    "assistant and that this call may be recorded for quality and training. Then continue: "
)
