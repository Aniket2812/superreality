...
from src.agents.concierge_agent import _RECORDING_NOTICE, ConciergeAgent
...
def test_opening_discloses_ai_voice_and_recording():
    notice = _RECORDING_NOTICE.lower()
    assert "ai assistant" in notice
